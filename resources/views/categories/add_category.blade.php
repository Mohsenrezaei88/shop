...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between page-header-breadcrumb flex-wrap gap-2">
        <div>
            ...
            <h1 class="page-title fw-medium fs-18 mb-0">افزودن دسته بندی</h1>
        </div>
    ...
    <!-- Start::row-1 -->
    <form action="{{ route('add_category.post') }}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                                ...
                                <div class="card custom-card text-center">
                                    <div class="card-body">
                                        <div id="preview-container" class="d-flex flex-column align-items-center">
                                            <img id="preview-image" src="{{ asset('images/default-category.png') }}"
                    ...
                    <div class="card-footer border-top border-block-start-dashed d-sm-flex justify-content-end">
                        <button class="btn btn-primary1 me-2 mb-2 mb-sm-0">
                            افزودن دسته بندی<i class="bi bi-plus-lg ms-2"></i>
                        </button>
                    </div>
                </div>
            </div>
