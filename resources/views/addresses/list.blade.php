                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <button onclick="window.location.href = '{{ route('orders_list') }}'"
                    ...
                    @foreach ($addresses as $key => $address)
                        <div class="card w-100 border border-primary">
                            <div class="card-header text-primary">
                                ...
                                <p class="fs-6 mb-0 mb-2">آدرس شماره {{ $key + 1 }}</p>
                                <div class="dropdown ms-auto">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li class="border-bottom"> <a class="dropdown-item"
                                                onclick="getaddress({{ $address->id }})" data-bs-toggle="modal"
                                                data-bs-target="#modal-change-address"><i class="ri-edit-2-line text-primary"></i>
                                                تغییر</a></li>
                                        <li class="border-bottom"><a class="dropdown-item" href="{{ route('delete_address' , [$address]) }}">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-secondary">کد پستی : {{ $address->pincode }}</p>
                                <p class="text-secondary">گیرنده : {{ $address->name }} | {{ $address->phone }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
