...
@section('content')
                                        ...
                                        <div class="form-check mt-2">
                                            ...
                                            <script>
                                                function makecode() {
                                                    ...
                                                    @endphp
                                                    window.location.replace('{{ route('make-code') }}')
                                                }
                                            </script>
                                        </div>
                                    </div>
    ...
    <script src="{{ url('../../assets/js/two-step-verification.js') }}"></script>
@endsection
