...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between page-header-breadcrumb flex-wrap gap-2">
        <div>
            ...
            <h1 class="page-title fw-medium fs-18 mb-0">ویرایش مقاله</h1>
        </div>
    </div>
    <!-- Page Header Close -->

    <!-- Start::row-1 -->
    <form action="{{ route('edit_post.post', [$post]) }}" method="Post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                        ...
                        <div class="row gx-4 mt-3">
                            ...
                            <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-6">
                                <div class="card custom-card shadow-none mb-0 border-0">
                                    <div class="card-body p-0">
                                        <div class="row gy-3">
                                            <div class="mb-3">
                                                <label class="label-form" for="image">(اختیاری)تصویر مقاله</label>
                                            ...
                                            <div class="mb-3 mt-4">
                                                ...
                                                <textarea class="form-control @error('body') is-invalid @enderror" rows="5" name="body">{{ $post->body }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-6">
                                <div class="mb-2 mt-3" id="divImage" style="height: 350px">
                                    <img type="image" class="w-100 h-100 rounded" src="{{ asset($post->image) }}"
                                        alt="p-image" id="p-image">
                    ...
                    <div class="card-footer border-top border-block-start-dashed d-sm-flex justify-content-end">
                        <button class="btn btn-primary1 me-2 mb-2 mb-sm-0">ویرایش مقاله<i
