            ...
            <div class="card custom-card overflow-hidden">
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <button onclick="window.location.href = '<?php echo e(route('address_list')); ?>'" class="btn btn-outline-secondary btn-wave waves-effect waves-light w-100">
                                آدرس ها
                            </button>
                        </li>
                    </ul>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\class\laravel\backups\shop-app\resources\views/orders/orders_list.blade.php ENDPATH**/ ?>