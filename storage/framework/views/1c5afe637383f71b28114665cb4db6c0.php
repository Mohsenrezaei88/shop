...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(url('../.../../assets/images/brand-logos/favicon.ico')); ?>" type="image/x-icon">
    <link rel="stylesheet" href="<?php echo e(asset('assets/libs/dropzone/dropzone.css')); ?>">

    <!-- Start::Styles -->

    <!-- Choices JS -->
    <script src="<?php echo e(url('../../assets/libs/choices.js/public/assets/scripts/choices.min.js')); ?>"></script>

    <!-- Main Theme Js -->
    <script src="<?php echo e(url('../../assets/js/main.js')); ?>"></script>

    <!-- Bootstrap Css -->
    <link id="style" href="<?php echo e(url('../../assets/libs/bootstrap/css/bootstrap.rtl.min.css')); ?>" rel="stylesheet">
    ...
    <!-- Node Waves Css -->
    <link href="<?php echo e(url('../../assets/libs/node-waves/waves.min.css')); ?>" rel="stylesheet">

    <!-- Simplebar Css -->
    <link href="<?php echo e(url('../../assets/libs/simplebar/simplebar.min.css')); ?>" rel="stylesheet">

    <!-- Color Picker Css -->
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/flatpickr/flatpickr.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/%40simonwep/pickr/themes/nano.min.css')); ?>">

    <!-- Choices Css -->
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/choices.js/public/assets/styles/choices.min.css')); ?>">

    <!-- FlatPickr CSS -->
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/flatpickr/flatpickr.min.css')); ?>">

    <!-- Auto Complete CSS -->
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/%40tarekraafat/autocomplete.js/css/autoComplete.css')); ?>">
    <!-- End::Styles -->
    ...
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/flatpickr/flatpickr.min.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(url('../../assets/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.css')); ?>">
    <link rel="stylesheet"
        href="<?php echo e(url('../../assets/libs/filepond-plugin-image-edit/filepond-plugin-image-edit.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/flatpickr/flatpickr.min.css')); ?>">
    ...
    <!-- Swiper Css -->
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/swiper/swiper-bundle.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('../../assets/libs/prismjs/themes/prism-coy.min.css')); ?>">
                ...
                <div class="main-header-container container-fluid">
                    ...
                    <div class="header-content-left">
                        <div class="header-element">
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-primary mx-1" type="button">ورود</a>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary mx-1" type="button">ثبت
                                نام</a>
                        </div>
                    </div>
                <?php else: ?>
...
<?php echo $__env->yieldPushContent('hide'); ?>
                            </div>
                    <?php endif; ?>
            <?php endif; ?>
            ...
            <ul class="header-content-right">
                ...
                <li class="header-element">
                    <!-- Start::header-link|layout-setting -->
                    <a href="<?php echo e(route('posts')); ?>" class="header-link layout-setting">
                        <span>
                            <!-- Start::header-link-icon -->
                ...
                <?php if(Auth::check()): ?>
                    <li class="header-element cart-dropdown dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle"
                            ...
                            <?php if(Auth::user()->cart != null and
                                ...
                                <span class="badge bg-secondary rounded-pill header-icon-badge"
                                    id="cart-icon-badge"><?php echo e(Auth::user()->cart->where('order_id', null)->where('user_id', Auth::user()->id)->get()->count()); ?></span>
                            <?php else: ?>
                                <span class="badge bg-secondary rounded-pill header-icon-badge"
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end"
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <?php if(Auth::user()->cart != null and
                                        ...
                                        <p class="mb-0 fs-15 fw-medium">اقلام سبد خرید<span
                                                ...
                                                id="cart-data"><?php echo e(Auth::user()->cart->where('order_id', null)->where('user_id', Auth::user()->id)->count()); ?></span>
                                        </p>
                                    <?php endif; ?>
                                    <?php if(Auth::user()->cart != null and Auth::user()->cart->where('order_id', null)->get()->count() > 0): ?>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <h6 class="mb-0"><?php echo e($price); ?></h6>
                                        </div>
                                </div>
                            </div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-0">
                                                    ...
                                                    <div class="text-end">
                                                        ...
                                                        <h6 class="fw-medium mb-0 mt-3"><span
                                                                ...
                                                                کل :</span><?php echo e($product->price); ?></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="p-3 empty-header-item border-top d-flex gap-2 align-items-center">
                                <a href="<?php echo e(route('cart')); ?>" class="btn flex-fill btn-primary btn-wave">رفتن به سبد
                                    خرید</a>
                            </div>
                        <?php else: ?>
                            <div class="p-5 empty-item w-100">
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo e(route('index')); ?>" class="btn btn-primary1 btn-wave btn-sm m-1"
                ...
                <?php if(Auth::check()): ?>
                    <li class="header-element notifications-dropdown d-xl-block d-none dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown"
                            ...
                            <?php if(Auth::user()->notifications->where('status', 0)->count() != 0): ?>
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end"
                            ...
                            <div class="p-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <span class="badge bg-secondary text-fixed-white"
                                        id="notifiation-data"><?php echo e(Auth::user()->notifications->where('status', 0)->count()); ?>
                            ...
                            <ul class="list-unstyled mb-0" id="header-notification-scroll">
                                <?php $__currentLoopData = Auth::user()->notifications->where('status', 0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="dropdown-item">
                                        <a href="<?php echo e(route('read_notif', [$notif])); ?>">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        <p class="mb-0 fw-medium"><a
                                                                href="<?php echo e(route('read_notif', [$notif])); ?>"><?php echo e($notif->title); ?></a>
                                                        </p>
                                                        <div
                                                            class="text-muted fw-normal fs-12 header-notification-text text-truncate">
                                                            <?php echo e($notif->text); ?></div>
                            ...
                            <div class="p-3 empty-header-item1 border-top">
                                <div class="d-grid">
                                    <a href="<?php echo e(route('read_notif', ['none'])); ?>"
                ...
                <?php if(Auth::check()): ?>
                    <li class="header-element dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <img src="<?php echo e(url('../../assets/images/faces/15.jpg')); ?>" alt="img"
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                            ...
                            <li>
                                <div class="dropdown-item text-center border-bottom">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('adminorwriter', 'App\\Models\User')): ?>
                                        <?php if(Auth::user()->role->role == "admin"): ?>
                                            <span class="d-block fs-12 text-muted">ادمین</span>
                                        <?php else: ?>
                                            <span class="d-block fs-12 text-muted">نویسنده</span>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                            </li>
                            <li><a class="dropdown-item d-flex align-items-center"
                                    href="<?php echo e(route('orders_list')); ?>"><i
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin', 'App\\Models\User')): ?>
                                <li><a class="dropdown-item d-flex align-items-center"
                                        href="<?php echo e(route('admin.panel')); ?>"><i
                            ...
                            <?php if(Auth::check()): ?>
                                <?php if(Auth::user()->role_id == 2): ?>
                                    <li><a class="dropdown-item d-flex align-items-center"
                                           href="<?php echo e(route('writer_panel')); ?>"><i
                                                class="ri-admin-line p-1 rounded-circle bg-primary-transparent me-2 fs-13"></i>مقالات من</a></li>
                                <?php endif; ?>
                            <?php endif; ?>
                            <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('orders_list')); ?>">
                            ...
                            <li><a class="dropdown-item d-flex align-items-center"
                                    href="<?php echo e(route('address_list')); ?>"><i
                                        class="fe fe-map p-1 rounded-circle bg-primary-transparent me-2 fs-16"></i>آدرس
                                    ها</a>
                            </li>
                            
                            <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('logout')); ?>"><i
        ...
        <div style="margin-top: 80px; margin-right: 0;" class="main-content app-content">
            <div class="container-fluid">
                ...
                <a class="global-btn" href="javascript:void(0);" data-bs-toggle="offcanvas"
                   ...
                   class="chatnameperson responsive-userinfo-open"><img src="<?php echo e(asset('icons/support.svg')); ?>"
                                                                        alt=""></a>
            </div>
        </div>
    <div class="offcanvas offcanvas-start mb-0" tabindex="-1" id="offcanvasRight">
                    ...
                    <div class="d-flex align-items-center border-bottom main-chat-head flex-wrap">
                        <span class="avatar avatar-md online chatstatusperson me-2 lh-1">
                            <img class="chatimageperson" style="height: 50px; width: 50px;"
                                src="<?php echo e(asset('site/support.png')); ?>" alt="img">
                        </span>
                        <div class="flex-fill">
                    ...
                    <div class="chat-content" id="main-chat-content" style="width: 50px!imporatant;height: 100%;">
                        <ul class="list-unstyled" id="ul-messages">
                            <?php if($chats->count() > 0): ?>
                                ...
                                ?>
                                <?php if($date != Morilog\Jalali\Jalalian::now()->format('m/d')): ?>
                            ...
                            <?php if($chats->count() > 0): ?>
                                <?php $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($message->created_at_shamsi != $date): ?>
                                        <?php if(\Morilog\Jalali\Jalalian::now()->format('m/d') == $message->created_at_shamsi): ?>
                                            <li class="chat-day-label">
                                                <span>امروز</span>
                                            </li>
                                        <?php else: ?>
                                            <li class="chat-day-label">
                                                <span><?php echo e($message->created_at_shamsi); ?></span>
                                            </li>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php
                                                ...
                                                <div class="chat-user-profile">
                                                    <span class="avatar avatar-md online chatstatusperson">
                                                        <img class="chatimageperson"
                                                            src="<?php echo e(asset('assets/images/faces/15.jpg')); ?>"
                                                            alt="img">
                                                    </span>
                                                </div>
                                                <div class="ms-3">
                                                    <div class="main-chat-msg">
                                                        <div>
                                                            <p class="mb-0"><?php echo e($message->text); ?></p>
                                                        </div>
                                                    </div>
                                                    <span class="chatting-user-info">
                                                        <span class="chatnameperson">شما</span> <span
                                                            class="msg-sent-time"><?php echo e($message->created_at->format('H:i')); ?></span>
                                                    </span>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="chat-item-end">
                                            <div class="chat-list-inner">
                                                <div class="me-3">
                                                    <div class="main-chat-msg">
                                                        <div>
                                                            <p class="mb-0"><?php echo $message->text; ?></p>
                                                        </div>
                                                    </div>
                                                    <span class="chatting-user-info">
                                                        <span class="msg-sent-time"><span
                                                                class="chat-read-mark align-middle d-inline-flex"><i
                                                                    class="ri-check-double-line"></i></span><?php echo e($message->created_at->format('H:i')); ?></span>
                                                        پشتیبانی
                                                    </span>
                                                </div>
                                                <div class="chat-user-profile">
                                                    <span class="avatar avatar-md online">
                                                        <img src="<?php echo e(asset('site/support.png')); ?>" alt="img">
                                                    </span>
                                                </div>
                                            </div>
                                        </li>
        ...
        <script>
            date = <?php echo e(Morilog\Jalali\Jalalian::now()->format('m/d')); ?>

            now = <?php echo e(Morilog\Jalali\Jalalian::now()->format('m/d')); ?>
...
<li class="chat-item-start" id="last">
    <div class="chat-list-inner">
        <div class="chat-user-profile">
            <span class="avatar avatar-md online chatstatusperson">
            <img class="chatimageperson" src="<?php echo e(asset('assets/images/faces/15.jpg')); ?>" alt="img">
            </span>
        </div>
        <div class="ms-3">
            <div class="main-chat-msg">
            ...
            <span class="chatting-user-info">
                ...
                <span class="msg-sent-time"><?php echo e(now()->format('H:i')); ?></span>
            </span>
        </div>
    </div>
</li>
`;
    ...
    <span class="visually-hidden">بارگذاری</span>
            ...
            `);
                ...
                console.log(message)
                $.ajax({
                    url: "<?php echo e(route('support_index')); ?>",
                    type: "post",
                    data: {
        ...
        <span class="msg-sent-time"><span
        class="chat-read-mark align-middle d-inline-flex"><i
        class="ri-check-double-line"></i></span><?php echo e(now()->format('H:i')); ?></span> پشتیبانی
        </span>
        </div>
        <div class="chat-user-profile">
        <span class="avatar avatar-md online">
        <img class="chatimageperson" src="<?php echo e(asset('site/support.png')); ?>" alt="img">
                        </span>
                    </div>
                 </div>
            </li>
    ...
    <!-- Scroll To Top -->
    <!-- Popper JS -->
    <script src="<?php echo e(url('../../assets/libs/%40popperjs/core/umd/popper.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(url('../../assets/js/simplebar.js')); ?>"></script>

    <!-- Auto Complete JS -->
    

    <!-- Color Picker JS -->
    <script src="<?php echo e(url('../../assets/libs/%40simonwep/pickr/pickr.es5.min.js')); ?>"></script>

    <!-- Date & Time Picker JS -->
    <script src="<?php echo e(url('../../assets/libs/flatpickr/flatpickr.min.js')); ?>"></script>
    <!-- End::main-scripts -->
    ...
    <!-- Toastify JS -->
    <script src="<?php echo e(url('../../assets/libs/toastify-js/src/toastify.js')); ?>"></script>
    ...
    <script src="<?php echo e(url('../../assets/js/pos-dashboard.js')); ?>"></script>

    <!-- Sticky JS -->
    <script src="<?php echo e(url('../../assets/js/sticky.js')); ?>"></script>

    <!-- Defaultmenu JS -->
    <script src="<?php echo e(url('../../assets/js/defaultmenu.min.js')); ?>"></script>
    ...
    <!-- Datatables Cdn -->
    <script src="<?php echo e(url('./assets/libs/datatables/jquery.dataTables.min.js')); ?>"></script>
...
<?php /**PATH D:\class\laravel\backups\shop-app\resources\views/layout/master.blade.php ENDPATH**/ ?>