                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <div class="d-flex gap-4 align-items-center flex-wrap">
                                <div class="d-flex gap-2 kanban-board">
                                    <a href="<?php echo e(route('add_post')); ?>" class="btn btn-primary btn-w-lg"><i class="ri-add-line me-1 fw-medium align-middle"></i>مقاله
                                        جدید</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-header justify-content-between">
                                        <div class="mb-3 w-100">
                                            <div class="d-flex justify-content-center align-items-center rounded position-relative overflow-hidden text-white"
                                                 style="height:30px;">
                                                <img src="<?php echo e(asset('site/media-36.jpg')); ?>"
                                                     class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover"
                                                     alt="bg">
                                                <span class="position-relative fw-bold fs-6"><?php echo e($post->title); ?></span>
                                            </div>
                                            <div class="mt-2" style="height: 280px ;">
                                                <img class="w-100 h-100 rounded" src="<?php echo e(asset($post->image)); ?>"
                                                     alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <p class="kanban-task-description text-truncate"><?php echo e($post->body); ?></p>
                                    </div>
                                    <div class="p-3 border-top border-block-start-dashed w-100">
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="w-100 row">
                                                <div class="col px-2">
                                                    <a href="<?php echo e(route('post_details', [$post])); ?>"
                                                       class="btn btn-primary btn-glare w-100">مشاهده</a>
                                                </div>
                                                <div class="col px-2">
                                                    <a href="<?php echo e(route('delete_post' , [$post])); ?>" class="btn btn-danger-gradient btn-wave waves-effect waves-light w-100">حذف</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\class\laravel\backups\shop-app\resources\views/writer/index.blade.php ENDPATH**/ ?>