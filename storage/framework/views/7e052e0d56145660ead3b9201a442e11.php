                    ...
                    <script>
                        $(document).ready(
                            $("#posts-list").DataTable({
                                processing: true,
                                serverSide: true,
                                ajax: "<?php echo e(route('posts_list.post')); ?>",
                                columns: [{
                                        data: 'title',
                                        name: 'title'
                                    },
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\class\laravel\shop-app\resources\views/posts/list.blade.php ENDPATH**/ ?>